...
def showMaps():
    ...
    try:
       ...
       messagebox.showinfo("Error", "The country you have entered does not exist within our system, please try again, be sure to have correct spelling and capatlized first letters.") 

btn = Button(root , text="Show Image", bg="green", command=showMaps)
